...
plt.scatter(x, y_values, c=color, cmap=color_map, vmin=0, vmax=3, edgecolors='black', linewidths=3, s=300, alpha=0.5)
...
plt.savefig('Fig_S12A_left.png')
plt.close()

################################
hist_all, bin_edges_all = np.histogram(m_response_reversal_index, bins=65, range=(-5, 60))

hist_stable, bin_edges_stable = np.histogram(m_response_reversal_index[indices_stable_reversal], bins=65, range=(-5, 60))
hist_unstable, bin_edges_unstable = np.histogram(m_response_reversal_index[indices_unstable], bins=65, range=(-5, 60))
hist_one_dead, bin_edges_one_dead = np.histogram(m_response_reversal_index[indices_one_dead], bins=65, range=(-5, 60))
hist_no_reversal, bin_edges_no_reversal = np.histogram(m_response_reversal_index[indices_stable_no_reversal], bins=65, range=(-5, 60))
...
plt.savefig('Fig_S12A_middle.png')
plt.close()
...
plt.savefig('Fig_S12A_right.png')
plt.close()