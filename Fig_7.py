...
for alpha in l_alpha:
    ...
    for i in range(T):
        ...
        if i == 49999:
            ...
            K_SV = (
                (p_pp + p_pp_prime * r_p) * (p_ee + p_ee_prime * r_e) * Jee * Jpp * Jsv
                - (p_ep + p_ep_prime * r_p) * Jsv * Jpe * Jep
                - (p_pp + p_pp_prime * r_p) * Jpp * Jsv
                + (p_ee + p_ee_prime * r_e) * Jee * Jsv
                - Jsv
            )
            K_SS = (
                (p_ep + p_ep_prime * r_p) * Jpe * Jep
                - (p_pp + p_pp_prime * r_p) * (p_ee + p_ee_prime * r_e) * Jee * Jpp
                + (p_pp + p_pp_prime * r_p) * Jpp
                - (p_ee + p_ee_prime * r_e) * Jee
                + 1
            )
            ...
            mat_R = np.array(
                [
                    [
                        1 - (p_ee + p_ee_prime * r_e) * Jee,
                        (p_ep + p_ep_prime * r_p) * Jep,
                        Jes,
                        Jev,
                    ],
...
plt.plot(
    l_eig_E_E_STP_sign_change_idx[0],
    0,
    marker="o",
    color="purple",
